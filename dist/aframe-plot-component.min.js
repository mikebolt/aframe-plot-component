!function(e){function t(n){if(r[n])return r[n].exports;var i=r[n]={exports:{},id:n,loaded:!1};return e[n].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var r={};return t.m=e,t.c=r,t.p="",t(0)}([function(e,t,r){function n(e){var t=new THREE.AxisHelper;return t}function i(e){var t=new THREE.MeshLambertMaterial;t.side=THREE.DoubleSide,t.transparent=!0,t.opacity=1/8,t.color=new THREE.Color(2245819);var r=new THREE.Object3D,n=e[1]-e[0],i=e[3]-e[2],a=e[5]-e[4],o=new THREE.PlaneGeometry(n,i),s=new THREE.Mesh(o,t);s.position.set(e[0]+n/2,e[2]+i/2,0),r.add(s);var u=new THREE.PlaneGeometry(n,a),c=new THREE.Mesh(u,t);c.position.set(e[0]+n/2,0,e[4]+a/2),c.rotation.set(Math.PI/2,0,0),r.add(c);var f=new THREE.PlaneGeometry(a,i),l=new THREE.Mesh(f,t);return l.position.set(0,e[2]+i/2,e[4]+a/2),l.rotation.set(0,Math.PI/2,0),r.add(l),r}function a(e){var t=e[1]-e[0],r=e[3]-e[2],n=e[5]-e[4],i=new THREE.PlaneGeometry(n,r),a=new THREE.PlaneGeometry(t,n),o=new THREE.PlaneGeometry(t,r),s=new THREE.MeshLambertMaterial;s.side=THREE.DoubleSide,s.color=new THREE.Color(14540253),s.transparent=!0,s.opacity=1/8;var u=new THREE.Mesh(i,s);u.position.set(e[0],e[2]+r/2,e[4]+n/2),u.rotation.set(0,Math.PI/2,0);var c=new THREE.Mesh(i,s);c.position.set(e[1],e[2]+r/2,e[4]+n/2),c.rotation.set(0,Math.PI/2,0);var f=new THREE.Mesh(a,s);f.position.set(e[0]+t/2,e[2],e[4]+n/2),f.rotation.set(Math.PI/2,0,0);var l=new THREE.Mesh(a,s);l.position.set(e[0]+t/2,e[3],e[4]+n/2),l.rotation.set(Math.PI/2,0,0);var p=new THREE.Mesh(o,s);p.position.set(e[0]+t/2,e[2]+r/2,e[4]);var h=new THREE.Mesh(o,s);h.position.set(e[0]+t/2,e[2]+r/2,e[5]);var m=new THREE.Object3D;return m.add(u,c,f,l,p,h),m}function o(e,t,r){var n=[];const i=r[1]-r[0],a=r[5]-r[4];for(var o=0;o<t;++o){for(var s=r[0]+o*i/(t-1),c=[],f=0;f<t;++f){var l=r[4]+f*a/(t-1),p=e(s,l);c.push(p)}n.push(c)}var h=new u(t,r,n),m=new THREE.MeshLambertMaterial({color:16777215});m.side=THREE.DoubleSide;var d=new THREE.Mesh(h,m);return d}const s=r(2),u=r(1);if("undefined"==typeof AFRAME)throw new Error('"Plot" component attempted to register before AFRAME was available.');AFRAME.registerComponent("plot",{schema:{function:{type:"string",default:"0"},order:{type:"number",default:32},label_text:{type:"string",default:""},show_formula:{type:"boolean",default:!1},show_axes:{type:"boolean",default:!0},bounds:{type:"string",default:"-1 1 -1 1 -1 1"},show_zero_planes:{type:"boolean",default:!1},show_bounding_box:{type:"boolean",default:!1}},multiple:!1,init:function(){var e=s.compile(this.data.function),t=function(t,r){var n={x:t,y:r};return e.eval(n)},r=new THREE.Object3D,u=this.data.bounds.split(" ").map(function(e){return parseFloat(e)});if(this.data.axes_enabled===!0){var c=n();r.add(c)}if(this.data.show_zero_planes===!0){var f=i(u);r.add(f)}if(this.data.show_bounding_box===!0){var l=a(u);r.add(l)}var p=o(t,this.data.order,u);r.add(p),this.el.setObject3D("mesh",r)}})},function(e,t){function r(e,t,r){function n(e){f[p++]=e.x,f[p++]=e.y,f[p++]=e.z}function i(e){l[h++]=e.x,l[h++]=e.y,l[h++]=e.z}function a(e,t,r){var n=t.clone().sub(e),i=r.clone().sub(e),a=n.cross(i);return a.normalize(),a}function o(){this.array=null}this.order=e,this.values=r;var s=(e-1)*(e-1)*2,u=3*s,c=3*u,f=new Float32Array(c),l=new Float32Array(c),p=0,h=0;const m=t[1]-t[0],d=t[5]-t[4],v=m/(e-1),g=d/(e-1);for(var y=0;y<e-1;++y)for(var x=t[0]+y*v,w=0;w<e-1;++w){var b=t[4]+w*g,N=r[y][w],E=r[y+1][w],M=r[y][w+1],A=r[y+1][w+1],O=new THREE.Vector3(x,M,b+g),T=new THREE.Vector3(x+v,E,b),_=new THREE.Vector3(x,N,b),S=a(O,T,_);n(O),i(S),n(T),i(S),n(_),i(S),O=new THREE.Vector3(x+v,E,b),T=new THREE.Vector3(x,M,b+g),_=new THREE.Vector3(x+v,A,b+g),S=a(O,T,_),n(O),i(S),n(T),i(S),n(_),i(S)}this.addAttribute("position",new THREE.BufferAttribute(f,3).onUpload(o)),this.computeVertexNormals()}r.prototype=new THREE.BufferGeometry,e.exports=r},function(e,t,r){/**
	 * math.js
