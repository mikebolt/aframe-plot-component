!function(e){function t(n){if(r[n])return r[n].exports;var i=r[n]={exports:{},id:n,loaded:!1};return e[n].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var r={};return t.m=e,t.c=r,t.p="",t(0)}([function(e,t,r){function n(e){var t=new THREE.AxisHelper;return t}function i(e){var t=new THREE.MeshLambertMaterial;t.side=THREE.DoubleSide,t.transparent=!0,t.opacity=1/8,t.color=new THREE.Color(2245819);var r=new THREE.Object3D,n=e[1]-e[0],i=e[3]-e[2],a=e[5]-e[4],o=new THREE.PlaneGeometry(n,i),s=new THREE.Mesh(o,t);s.position.set(e[0]+n/2,e[2]+i/2,0),r.add(s);var u=new THREE.PlaneGeometry(n,a),c=new THREE.Mesh(u,t);c.position.set(e[0]+n/2,0,e[4]+a/2),c.rotation.set(Math.PI/2,0,0),r.add(c);var f=new THREE.PlaneGeometry(a,i),l=new THREE.Mesh(f,t);return l.position.set(0,e[2]+i/2,e[4]+a/2),l.rotation.set(0,Math.PI/2,0),r.add(l),r}function a(e){var t=e[1]-e[0],r=e[3]-e[2],n=e[5]-e[4],i=new THREE.PlaneGeometry(n,r),a=new THREE.PlaneGeometry(t,n),o=new THREE.PlaneGeometry(t,r),s=new THREE.MeshLambertMaterial;s.side=THREE.DoubleSide,s.color=new THREE.Color(14540253),s.transparent=!0,s.opacity=1/8;var u=new THREE.Mesh(i,s);u.position.set(e[0],e[2]+r/2,e[4]+n/2),u.rotation.set(0,Math.PI/2,0);var c=new THREE.Mesh(i,s);c.position.set(e[1],e[2]+r/2,e[4]+n/2),c.rotation.set(0,Math.PI/2,0);var f=new THREE.Mesh(a,s);f.position.set(e[0]+t/2,e[2],e[4]+n/2),f.rotation.set(Math.PI/2,0,0);var l=new THREE.Mesh(a,s);l.position.set(e[0]+t/2,e[3],e[4]+n/2),l.rotation.set(Math.PI/2,0,0);var p=new THREE.Mesh(o,s);p.position.set(e[0]+t/2,e[2]+r/2,e[4]);var h=new THREE.Mesh(o,s);h.position.set(e[0]+t/2,e[2]+r/2,e[5]);var m=new THREE.Object3D;return m.add(u,c,f,l,p,h),m}function o(e,t,r,n,i,a,o){var s=[];const c=r[1]-r[0],f=r[5]-r[4];for(var l=0;l<t;++l){for(var p=r[0]+l*c/(t-1),h=[],m=0;m<t;++m){var d=r[4]+m*f/(t-1),v=e(p,d);h.push(v)}s.push(h)}var g=new u(t,r,s,i,a);const y={color:new THREE.Color(n)};var x=new THREE.MeshPhongMaterial(y);x.side=THREE.DoubleSide;var w=new THREE.Mesh(g,x);return w}const s=r(2),u=r(1);if("undefined"==typeof AFRAME)throw new Error('"Plot" component attempted to register before AFRAME was available.');AFRAME.registerComponent("plot",{schema:{function:{type:"string",default:"0"},order:{type:"number",default:32},label_text:{type:"string",default:""},show_formula:{type:"boolean",default:!1},show_axes:{type:"boolean",default:!0},bounds:{type:"string",default:"-1 1 -1 1 -1 1"},show_zero_planes:{type:"boolean",default:!1},show_bounding_box:{type:"boolean",default:!1},show_grid:{type:"boolean",default:!0},grix_x_scale:{type:"number",default:.1},grid_z_scale:{type:"number",default:.1},color:{type:"string",default:"#AAA"},animate:{type:"boolean",default:!1}},multiple:!1,init:function(){},createPlot:function(){null!==this.graphObject&&this.root.remove(this.graphObject),this.graphObject=o(this.F,this.data.order,this.bounds,this.data.color,this.data.grid_x_scale,this.data.grid_y_scale,this.data.show_grid),this.root.add(this.graphObject)},update:function(e){var t=s.compile(this.data.function),r={t:0};this.scope=r,this.F=function(e,n){return r.x=e,r.y=n,t.eval(r)},console.log(this.data);var o=new THREE.Object3D;if(this.root=o,this.bounds=this.data.bounds.split(" ").map(function(e){return parseFloat(e)}),this.data.axes_enabled===!0){var u=n();o.add(u)}if(this.data.show_zero_planes===!0){var c=i(this.bounds);o.add(c)}if(this.data.show_bounding_box===!0){var f=a(this.bounds);o.add(f)}this.graphObject=null,this.createPlot(),this.el.setObject3D("mesh",o),console.log(o)},tick:function(e){this.data.animate&&(this.scope.t=e%1e3/1e3,this.createPlot())}})},function(e,t){function r(e,t,r,n,i){function a(e,t,r,n){o(e),s(t),u(e.x,e.z)}function o(e){m[g++]=e.x,m[g++]=e.y,m[g++]=e.z}function s(e){d[y++]=e.x,d[y++]=e.y,d[y++]=e.z}function u(e,t){v[x++]=e/n,v[x++]=t/i}function c(e,t,r){var n=t.clone().sub(e),i=r.clone().sub(e),a=n.cross(i);return a.normalize(),a}function f(){this.array=null}THREE.BufferGeometry.call(this),this.order=e,this.values=r;var l=(e-1)*(e-1)*2,p=3*l,h=3*p,m=new Float32Array(h),d=new Float32Array(h),v=new Float32Array(2*p),g=0,y=0,x=0;const w=t[1]-t[0],b=t[5]-t[4],N=w/(e-1),E=b/(e-1);for(var M=0;M<e-1;++M)for(var A=t[0]+M*N,O=0;O<e-1;++O){var T=t[4]+O*E,_=r[M][O],S=r[M+1][O],C=r[M][O+1],z=r[M+1][O+1],k=new THREE.Vector3(A,C,T+E),P=new THREE.Vector3(A+N,S,T),I=new THREE.Vector3(A,_,T),B=c(k,P,I);a(k,B,M,O+1),a(P,B,M+1,O),a(I,B,M,O),k=new THREE.Vector3(A+N,S,T),P=new THREE.Vector3(A,C,T+E),I=new THREE.Vector3(A+N,z,T+E),B=c(k,P,I),a(k,B,M+1,O),a(P,B,M,O+1),a(I,B,M+1,O+1)}this.addAttribute("position",new THREE.BufferAttribute(m,3).onUpload(f)),this.addAttribute("uv",new THREE.BufferAttribute(v,2).onUpload(f)),this.computeVertexNormals()}r.prototype=Object.create(THREE.BufferGeometry.prototype),r.prototype.constructor=r,e.exports=r},function(e,t,r){/**
	 * math.js
